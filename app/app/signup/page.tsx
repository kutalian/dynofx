...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (password !== confirmPassword) {
            setFormAlert({ message: '✗ Passwords do not match', type: 'error' });
            setLoading(false);
            return;
        }
        ...
        try {
            ...
            if (error) {
                ...
                setFormAlert({ message: '✓ Account created! Please check your email.', type: 'success' });
                // Optional: Redirect to a "Check your email" page or Dashboard if email confirmation is disabled
                setTimeout(() => {
                    ...
                    <div className="auth-forms">
                        <div className="form-container active" style={{ display: 'block' }}>
                            <div className="form-header">
                                ...
                                <p>Start learning to trade in minutes</p>
                            </div>
                            ...
                            <form onSubmit={handleSignup}>
                                ...
                                <div className="form-group">
                                    ...
                                    <small style={{ color: 'var(--gray)', fontSize: '0.85rem', display: 'block', marginTop: '0.5rem' }}>
                                ...
                                >
                                    {loading ? (
                                        <>
                                            Creating Account<span className="spinner"></span>
                                        </>
                                    ) : (
                                        'Create Account'
                                    )}
